...
public class IcecreamController {
    ...
    @Operation(summary = "아이스크림 리스트", description = "아이스크림 종류 String : type,<br>" +
            "할인율 int : eventRate<br>" +
            "받음 //// 다 비워져있으면 모든 아이스크림 반환 ////" +
    ...
    @GetMapping("/img/{name}")
    @Operation(summary = "제품 이미지 반환", description = "string : img 아이스크림 정보의 img를 넣으면 img를 반환")
    ...
    @GetMapping("/{id}")
    @Operation(summary = "아이스크림 정보", description = "int : id 아이스크림 아이디를 입력하여 아이스크림 정보 획득")
